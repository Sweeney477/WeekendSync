      ...
      <div className="flex flex-col gap-8 px-4 pb-64">
        <div className="flex gap-2">
          <button
            ...
            className={`flex h-10 items-center justify-center rounded-xl px-5 text-sm font-bold transition-all ${category === "all" ? "bg-cyan-400 text-white" : "bg-white text-slate-400 border border-slate-100"
              }`}
          >
            All Events
          </button>
          <button
            ...
            className={`flex h-10 items-center justify-center rounded-xl px-5 text-sm font-bold transition-all ${category === "music" ? "bg-cyan-400 text-white" : "bg-white text-slate-400 border border-slate-100"
              }`}
          >
            Music
          </button>
          <button
            ...
            className={`flex h-10 items-center justify-center rounded-xl px-5 text-sm font-bold transition-all ${category === "sports" ? "bg-cyan-400 text-white" : "bg-white text-slate-400 border border-slate-100"
              }`}
          >
            Sports
          </button>
                ...
                <div key={e.externalEventId} className="flex flex-col gap-4">
                  <div className="relative aspect-video w-full overflow-hidden rounded-[32px] bg-slate-100 shadow-xl">
                    ...
                    <button
                      ...
                      className={`absolute bottom-4 right-4 flex h-10 w-10 items-center justify-center rounded-xl transition-all active:scale-[0.9] ${isSaved ? "bg-cyan-400 text-white" : "bg-white text-cyan-400"
                        }`}
                    >
                      <svg
