  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-md flex-col gap-6 px-4 py-8 pb-24">
      <header className="flex flex-col gap-2">
        ...
        <p className="text-sm text-slate-600">Pick a name your group will recognize. Home city is optional.</p>
      </header>

      <Card className="flex flex-col gap-3">
        <Input label="Display name" placeholder="e.g. Sam" value={displayName} onChange={(e) => setDisplayName(e.target.value)} />
